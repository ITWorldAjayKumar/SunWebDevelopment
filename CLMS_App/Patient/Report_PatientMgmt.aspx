<%@ Page Title="Patient List" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Report_PatientMgmt.aspx.cs" Inherits="CLMS_App.Patient.Report_PatientMgmt" %>
                                    ...
                                    <Columns>
                                       ...
                                       <%-- <asp:TemplateField HeaderText="Edit">
                                        ...
                                        <asp:TemplateField HeaderText="Reports">
                                            <ItemTemplate>
                                                <asp:ImageButton runat="server" ID="imgbtnReport" ImageUrl="~/Images/VitalReport_icon.png" PostBackUrl='<%# String.Format("~/Patient/ReportsMgmt.aspx?PatientID={0}",Eval("id")) %>' />
                                               <%-- <img runat="server" src="~/Images/VitalReport_icon.png">
                ...
                <ContentTemplate>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <asp:FormView runat="server" ID="frmvwAddUpdatePatient" DataKeyNames="ID" OnItemCommand="frmvwAddUpdatePatient_ItemCommand" DefaultMode="Insert">
                                <InsertItemTemplate>
                                    <div class="panel-body">
                                        <div class="col-md-6">
                                            <div class="form-group row">
