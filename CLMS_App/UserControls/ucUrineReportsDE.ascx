<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucUrineReportsDE.ascx.cs" Inherits="CLMS_App.UserControls.ucUrineReportsDE" %>
    ...
    <asp:FormView runat="server" ID="frmvwAddUpdateVitalSign" CssClass="fullwidth" DataKeyNames="ID" OnItemCommand="frmvwAddUpdateVitalSign_ItemCommand" DefaultMode="Insert">
        <InsertItemTemplate>
            <div class="panel panel-default">
                <div class="panel-heading">Add Update Urine Report</div>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <asp:TextBox runat="server" placeholder="Pulse" CssClass="form-control" ID="txtAlbumin" ClientIDMode="Static"></asp:TextBox>
                                </div>
                            </div>
