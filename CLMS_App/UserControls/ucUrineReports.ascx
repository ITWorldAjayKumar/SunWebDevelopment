<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucUrineReports.ascx.cs" Inherits="CLMS_App.UserControls.ucUrineReports" %>
...
<script type="text/javascript">
    ...
    function DrawLine(resultData) {
        ...
        var chart2 = new Highcharts.Chart({
            chart: { renderTo: 'containerUrine' },
            //$('#containerUrine').highcharts({
            //Highcharts.chart('containerUrine', {

            title: {
                text: resultData[0].PatientName + "- Vital Sign Report -Urine"
            },
